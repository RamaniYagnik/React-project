...
const Category = () => {
    ...
    <div className='flex flex-col mt-5'>
        <div className='flex flex-column lg:justify-center high-scroll-bar'>
            <div className='flex'>
                {category.map((item,index) => {
                    return (
                        <div className='px-3 lg:px-10' key={index}>
                            <div onClick={() => navigate(`/categorypage/${item.name}`)} className='w-16 h-16 lg:w-24 lg:h-24 max-w-xs rounded-full  bg-pink-500 transition-all hover:bg-pink-400 cursor-pointer mb-1'>
